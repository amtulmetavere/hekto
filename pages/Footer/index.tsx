    ...
    <div className="col-span-1">
      ...
      <form className="flex">
        <input
          ...
          className="px-5 py-[10px] w-[80%] text-[14px] rounded-[10px] text-[#8A8FB9] placeholder:text-[#8A8FB9] focus:outline-none"
        />
        <button
          type="submit"
...
const FooterPage = () => {
  return (
    ...
    <div className="w-[80%] lg:w-auto flex flex-row flex-wrap items-start mt-[95px] justify-between">
      <FooterForm />
      <Categories />
      <CustomerCare />
      <Pages />
